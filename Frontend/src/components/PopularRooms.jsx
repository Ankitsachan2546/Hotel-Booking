            ...
            roomData.map((room, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="w-full sm:w-[calc(50%-1.5rem)] md:w-[calc(33.33%-1.5rem)] lg:w-[calc(25%-1.5rem)] min-w-[280px] bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 cursor-pointer" /* Adjusted responsive widths */
                >
                  {/* Room Image Carousel */}
